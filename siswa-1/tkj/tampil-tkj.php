...
<div class="container">
  ...
  <div class="container-fluid">
    <div class="row">
        ...
        <center><h4><b>Program Studi Teknik Komputer Jaringan</b></h4></center><br>
        <!-- font ganti jenis -->
  		</div>
  		<div class="col-md-3">
  ...
  <table class="table table-bordered">
    ...
    <center>
    <a target="_blank" type="button" class="btn btn-info btn-md" href="cetak-tkj.php?nik=<?php echo $nik; ?>" >Cetak PDF</a>
  <?php
      } ?>
<br><br><br>
