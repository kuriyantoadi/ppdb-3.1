...
<head>
  <title>TKJ - PPDB SMKN 1 Kragilan</title>
  <meta charset="utf-8">
...
?>
    ...
    <form class="form-horizontal" action="tambah-tkj.php" name="input" method="POST" enctype="multipart/form-data" onSubmit="return validasi()">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-6">
          <input type="text" class="form-control" placeholder=" " name="kompetensi_keahlian" value="Teknik Komputer Jaringan" readonly>
        </div>
      </div>
      <div class="form-group">
