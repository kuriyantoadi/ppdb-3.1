    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <center>
            <h4><b>Bukti Pendaftaran Calon Peserta Didik Baru</b></h4>
          </center>
          <center>
      ...
      while ($d = mysqli_fetch_array($data)) {
        ...
        <center>
          <a target="_blank" type="button" class="btn btn-info btn-md" href="cetak-mesin.php?nik=<?php echo $nik; ?>">Cetak PDF</a>
          <?php
      } ?>
          <br><br><br>
