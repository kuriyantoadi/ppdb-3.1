...
<head>
  <title>Pemesinan - PPDB SMKN 1 Kragilan</title>
  <meta charset="utf-8">
...
?>
    ...
    <form class="form-horizontal" action="tambah-mesin.php" name="input" method="POST" enctype="multipart/form-data" onSubmit="return validasi()">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-6">
          ...
          <br>
          <p>1. Kompetensi Keahlian Pilihan ke-2 ini boleh tidak dipilih.
      ...
      <div class="form-group">
        ...
        <div class="col-sm-6">
          ...
          <br>
          <p>1. Jika sekolah tidak ada maka milih <b>"Nama Sekolah Tidak Ada"</b> dan sampaikan ke operator sekolah di live chat pendaftaran.
            <br>2. Untuk NPSN sekolah bisa tanya ke sekolah asal atau cari informasi di internet. </p>
        </div>
      </div>

      <br>
      <h4>B. IDENTITAS CALON PESERTA DIDIK BARU</h4>
      <div class="form-group">
      ...
      <br>
      <h4>C. DATA KEPENDUDUKAN CALON PESERTA DIDIK BARU</h4>
      <div class="form-group">
      ...
      <br>
      <h4>D. ALAMAT TEMPAT TINGGAL CALON PESERTA DIDIK BARU (SESUAI KK)</h4>
      <div class="form-group">
      ...
      <br>
      <h4>F. DATA ORANG TUA / WALI CALON PESERTA DIDIK</h4>
      <div class="form-group">
      ...
      <br>
      <h4>I. PERSYARATAN KHUSUS KOMPETENSI KEAHLIAN TEKNIK PEMESINAN</h4>
      <div class="form-group">
      ...
      <div class="form-group">
        <div class="col-sm-offset-2 col-sm-10">
          <button type="submit" name="upload" value="upload" class="btn btn-default" onclick="if (eval(ukuran)>0.5) { alert('Ukuran file pdf melebihi batas yaitu 500Kb'); return false; } else { return true; }">Submit</button>
        </div>
      </div>
    </form>
  </div>
