...
include 'header.php';
  ...
  <div class="container">
    <center>
      <h2>Tampilan POS 3 PPDB SMKN 1 Kragilan</h2>
    </center>
    <center>
      <h3></h3>
    </center>
    ...
    <div class="form-group">
      ...
      <br><br><label class="control-label col-sm-2" for="email">Cari Peserta Calon Peserta Didik :</label>
      <div class="col-sm-3">
    ...
    $result = mysqli_query($koneksi, "SELECT * FROM f_siswa_rpl");
    $total = mysqli_num_rows($result);
    $pages = ceil($total/$halperpage);

    $data = mysqli_query($koneksi, "SELECT * from f_siswa_rpl LIMIT $mulai, $halperpage ");
    $no = $mulai+1;
    ...
    while ($d = mysqli_fetch_array($data)) {
        ...
        <tr>
          ...
          <td>
            <center><?php echo $d['no_hp']; ?>
          </td>
          <td>
            <center><?php echo $d['no_hp_org_tua']; ?>
          </td>
