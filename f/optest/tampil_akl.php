  ...
  <table class="table table-bordered table-hover" id="domainsTable">
    ...
    while ($d = mysqli_fetch_array($data)) {
      ...
      <tr>
        ...
        <td>
          <center>
            <a style="margin: 5px;" type="button" class="btn btn-success btn-sm" href="val_ujikom_selesai.php?id=<?= $d['id'] ?>&kode_jur=akl" 
              onclick="return confirm('Anda yakin Selesai Uji Kompetensi data siswa <?php echo $d['nama_siswa']; ?> ?')">Selesai</a>
            <a style="margin: 5px;" type="button" class="btn btn-warning btn-sm" href="val_ujikom_belum.php?id=<?= $d['id'] ?>&kode_jur=akl"
