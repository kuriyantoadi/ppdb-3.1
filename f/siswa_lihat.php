        ...
        <form class="" action="validasi.php" method="post">
          ...
          <tr>
            ...
            <td>
              ...
              <embed src="../assets/file_upload/tkj/<?= $d['pdf_skhun']; ?>" type="application/pdf" width="100%" height="500px">
              <?php }else{ ?>
          ...
          <tr>
            ...
            <td>
              ...
              <embed src="../assets/file_upload/tkj/<?= $d['pdf_surat_dokter']; ?>" type="application/pdf" width="100%" height="500px">
              <?php }else{ ?>
              <h5>File Tidak Ada</h5>
              <?php } ?>
            </td>
          ...
          <tr>
            ...
            <td>
              ...
              <embed src="../assets/file_upload/tkj/<?= $d['pdf_kk']; ?>" type="application/pdf" width="100%" height="500px">
              <?php }else{ ?>
              <h5>File Tidak Ada</h5>
              <?php } ?>
            </td>
          ...
          <tr>
            ...
            <td>
              ...
              <embed src="../assets/file_upload/tkj/<?= $d['pdf_akta']; ?>" type="application/pdf" width="100%" height="500px">
              <?php }else{ ?>
              <h5>File Tidak Ada</h5>
              <?php } ?>
            </td>
          ...
          <tr>
            ...
            <td>
              ...
              <embed src="../assets/file_upload/tkj/<?= $d['pdf_photo']; ?>" type="application/pdf" width="100%" height="500px">
              <?php }else{ ?>
              <h5>File Tidak Ada</h5>
              <?php } ?>
            </td>
          ...
          <tr>
            ...
            <td>
              ...
              <embed src="../assets/file_upload/tkj/<?= $d['pdf_swa_kk']; ?>" type="application/pdf" width="100%" height="500px">
              <?php }else{ ?>
              <h5>File Tidak Ada</h5>
              <?php } ?>
            </td>
          ...
          <tr>
            ...
            <td>
              ...
              <embed src="../assets/file_upload/tkj/<?= $d['pdf_rapor_2']; ?>" type="application/pdf" width="100%" height="500px">
              <?php }else{ ?>
              <h5>File Tidak Ada</h5>
              <?php } ?>
            </td>
          ...
          <tr>
            ...
            <td>
              ...
              <embed src="../assets/file_upload/tkj/<?= $d['pdf_rapor_3']; ?>" type="application/pdf" width="100%" height="500px">
              <?php }else{ ?>
              <h5>File Tidak Ada</h5>
              <?php } ?>
            </td>
          ...
          <tr>
            ...
            <td>
              ...
              <embed src="../assets/file_upload/tkj/<?= $d['pdf_rapor_4']; ?>" type="application/pdf" width="100%" height="500px">
              <?php }else{ ?>
              <h5>File Tidak Ada</h5>
              <?php } ?>
            </td>
          ...
          <tr>
            ...
            <td>
              ...
              <embed src="../assets/file_upload/tkj/<?= $d['pdf_rapor_5']; ?>" type="application/pdf" width="100%" height="500px">
              <?php }else{ ?>
              <h5>File Tidak Ada</h5>
              <?php } ?>
            </td>
          ...
          <tr>
            ...
            <td>
              ...
              <embed src="../assets/file_upload/tkj/<?= $d['pdf_rapor_6']; ?>" type="application/pdf" width="100%" height="500px">
              <?php }else{ ?>
              <h5>File Tidak Ada</h5>
              <?php } ?>
            </td>
          ...
          <tr>
            ...
            <td>
              ...
              <embed src="../assets/file_upload/tkj/<?= $d['pdf_kip']; ?>" type="application/pdf" width="100%" height="500px">
              <?php }else{ ?>
              <h5>File Tidak Ada</h5>
              <?php } ?>
            </td>
          ...
          <tr>
            ...
            <td>
              ...
              <embed src="../assets/file_upload/tkj/<?= $d['pdf_piagam1']; ?>" type="application/pdf" width="100%" height="500px">
              <?php }else{ ?>
              <h5>File Tidak Ada</h5>
              <?php } ?>
            </td>
          ...
          <tr>
            ...
            <td>
              ...
              <embed src="../assets/file_upload/tkj/<?= $d['pdf_piagam2']; ?>" type="application/pdf" width="100%" height="500px">
              <?php  }else{ ?>
              <h5>File Tidak Ada</h5>
              <?php } ?>
            </td>
          ...
          <tr>
            ...
            <td>
              ...
              <embed src="../assets/file_upload/tkj/<?= $d['pdf_piagam3']; ?>" type="application/pdf" width="100%" height="500px">
              <?php }else { ?>
              <h5>File Tidak Ada</h5>
              <?php } ?>
