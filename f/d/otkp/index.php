...
include '../header.php';
  ...
  <div class="container">
    ...
    $data = mysqli_query($koneksi, "SELECT * from tb_siswa where kompetensi_keahlian='Otomatisasi dan Tata Kelola Perkantoran' ORDER BY nisn DESC LIMIT $mulai, $halperpage ");
    $no = $mulai+1;
