...
<head>
  ...
  <script type="text/javascript" src="../assets/maxcdn/bootstrap.min.css"></script>

  <!-- <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.4.1/jquery.min.js"></script> -->
  <!-- <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js"></script> -->
  <script type="text/javascript" src="../assets/maxcdn/bootstrap.min.js"></script>
  ...
  <link href="../assets/datepicker/css/bootstrap.min.css" rel="stylesheet">
