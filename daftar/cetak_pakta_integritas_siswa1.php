    ...
    <div class="container">
        <div class="col-md-8 m-auto">
            <div class="col-6 m-auto">
                <p class="text-end">Kode Enkripsi:</p>
            </div>
            ...
            <table class="table table-borderless mb-5">
                <tr>
                    ...
                    <td>Nama Lengkap</td>
                    <td>: <div style="border-bottom: 1px dashed black; padding-right: 150px;"></div></td>
                </tr>
                <tr>
            ...
            <table class="table table-bordered border-dark text-center">
                <tr>
                    <td style="padding-bottom: 100px; width: 50%;">
                        <p>
                            Menyetujui; <br>
                            Orangtua/Wali
                        </p>
