...
?>
  ...
  <div class="panel panel-primary">
    <div class="panel-heading">
      <h3 class="panel-title">Status Pengumuman</h3>
    </div>
    <div class="panel-body">
      <table class="table table-bordered">
        ...
        <?php
        $data_seleksi = mysqli_query($koneksi, "select * from tb_siswa, tb_lolos where tb_siswa.nik=tb_lolos.nik AND tb_lolos.nik='$nik' ");
        while ($d_seleksi = mysqli_fetch_array($data_seleksi)) {
        ?>
          <tr>
            <th width="250px">Hasil Seleksi</th>
            <td>
