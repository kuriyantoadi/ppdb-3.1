    ...
    <?php
      ...
      while ($d = mysqli_fetch_array($data)) {
          ...
          <tr>
            <td>SKHUN</td>
            <td>
              <a href="../../assets/file_upload/tkr/<?= $d['pdf_skhun'] ?>" class="btn btn-primary">Download</a>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td>
              <a href="../../assets/file_upload/tkr/<?= $d['pdf_kk'] ?>" class="btn btn-primary">Download</a>
            </td>
          </tr>
          <tr>
            <td>Akta Kelahiran</td>
            <td>
              <a href="../../assets/file_upload/tkr/<?= $d['pdf_akta'] ?>" class="btn btn-primary">Download</a>
            </td>
          </tr>
          <tr>
            <td>Photo</td>
            <td>
              <a href="../../assets/file_upload/tkr/<?= $d['pdf_photo'] ?>" class="btn btn-primary">Download</a>
            </td>
          </tr>
          <tr>
            <td>SwaPhoto</td>
            <td>
              <a href="../../assets/file_upload/tkr/<?= $d['pdf_swa_kk'] ?>" class="btn btn-primary">Download</a>
            </td>
          </tr>
          <tr>
            <td>Rapor Semester 2</td>
            <td>
              <a href="../../assets/file_upload/tkr/<?= $d['pdf_rapor_2'] ?>" class="btn btn-primary">Download</a>
            </td>
          </tr>
          <tr>
            <td>Rapor Semester 3</td>
            <td>
              <a href="../../assets/file_upload/tkr/<?= $d['pdf_rapor_3'] ?>" class="btn btn-primary">Download</a>
            </td>
          </tr>
          <tr>
            <td>Rapor Semester 4</td>
            <td>
              <a href="../../assets/file_upload/tkr/<?= $d['pdf_rapor_4'] ?>" class="btn btn-primary">Download</a>
            </td>
          </tr>
          <tr>
            <td>Rapor Semester 5</td>
            <td>
              <a href="../../assets/file_upload/tkr/<?= $d['pdf_rapor_5'] ?>" class="btn btn-primary">Download</a>
            </td>
          </tr>
          <tr>
            <td>Rapor Semester 6</td>
            <td>
              <a href="../../assets/file_upload/tkr/<?= $d['pdf_rapor_6'] ?>" class="btn btn-primary">Download</a>
            </td>
          </tr>
          <tr>
            <td>KIP</td>
            <td>
              ...
              <a href="../../assets/file_upload/tkr/<?= $d['pdf_kip'] ?>" class="btn btn-primary">Download</a>
            <?php } ?>
            </td>
          </tr>
          <tr>
            ...
            <td>
              ...
              <a href="../../assets/file_upload/tkr/<?= $d['pdf_piagam1'] ?>" class="btn btn-primary">Download</a>
            <?php } ?>
            </td>
          </tr>
          <tr>
            ...
            <td>
              ...
              <a href="../../assets/file_upload/tkr/<?= $d['pdf_piagam2'] ?>" class="btn btn-primary">Download</a>
            <?php } ?>
            </td>
          </tr>
          <tr>
            ...
            <td>
              ...
              <a href="../../assets/file_upload/tkr/<?= $d['pdf_piagam3'] ?>" class="btn btn-primary">Download</a>
            <?php } ?>
            </td>
          </tr>
